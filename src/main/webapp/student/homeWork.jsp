...
<body class="layui-view-body">
     <div class="layui-content" id="box" style="display:none">
          <form class="layui-form layui-form-pane" method="post" enctype="multipart/form-data" style="padding:20px;" action="<%=basePath%>swork/add" onsubmit="return toVaild()">
          ...
          <div class="layui-form-item">
             ...
             <div class="layui-input-block">
               <select name="ttid" id="ttid" lay-filter="aihao"></select>
             </div>
          </div>
          <div class="layui-form-item">
